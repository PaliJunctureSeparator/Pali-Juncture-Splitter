...
def animation_demo() -> None:
    ...
    if uppercase_check:
        ...
        s_sepa_v_or_S_sepa_V = s_sepa_v
    ak_sepa = s_sepa_v_or_S_sepa_V.replace("a"+sepa+"k"+sepa, "a"+"k"+sepa)
    ag_sepa = ak_sepa.replace("a"+sepa+"g"+sepa, "a"+"g"+sepa)
    aṅ_sepa = ag_sepa.replace("a"+sepa+"ṅ"+sepa, "a"+"ṅ"+sepa)
    ac_sepa = aṅ_sepa.replace("a"+sepa+"c"+sepa, "a"+"c"+sepa)
    aj_sepa = ac_sepa.replace("a"+sepa+"j"+sepa, "a"+"j"+sepa)
    añ_sepa = aj_sepa.replace("a"+sepa+"ñ"+sepa, "a"+"ñ"+sepa)
    aṭ_sepa = añ_sepa.replace("a"+sepa+"ṭ"+sepa, "a"+"ṭ"+sepa)
    aḍ_sepa = aṭ_sepa.replace("a"+sepa+"ḍ"+sepa, "a"+"ḍ"+sepa)
    aṇ_sepa = aḍ_sepa.replace("a"+sepa+"ṇ"+sepa, "a"+"ṅ"+sepa)
    at_sepa = aṇ_sepa.replace("a"+sepa+"t"+sepa, "a"+"t"+sepa)
    ad_sepa = at_sepa.replace("a"+sepa+"d"+sepa, "a"+"d"+sepa)
    an_sepa = ad_sepa.replace("a"+sepa+"n"+sepa, "a"+"n"+sepa)
    ap_sepa = an_sepa.replace("a"+sepa+"p"+sepa, "a"+"p"+sepa)
    ab_sepa = ap_sepa.replace("a"+sepa+"b"+sepa, "a"+"b"+sepa)
    am_sepa = ab_sepa.replace("a"+sepa+"m"+sepa, "a"+"m"+sepa)
 
    ik_sepa = am_sepa.replace("i"+sepa+"k"+sepa, "i"+"k"+sepa)
    ig_sepa = ik_sepa.replace("i"+sepa+"g"+sepa, "i"+"g"+sepa)
    iṅ_sepa = ig_sepa.replace("i"+sepa+"ṅ"+sepa, "i"+"ṅ"+sepa)
    ic_sepa = iṅ_sepa.replace("i"+sepa+"c"+sepa, "i"+"c"+sepa)
    ij_sepa = ic_sepa.replace("i"+sepa+"j"+sepa, "i"+"j"+sepa)
    iñ_sepa = ij_sepa.replace("i"+sepa+"ñ"+sepa, "i"+"ñ"+sepa)
    iṭ_sepa = iñ_sepa.replace("i"+sepa+"ṭ"+sepa, "i"+"ṭ"+sepa)
    iḍ_sepa = iṭ_sepa.replace("i"+sepa+"ḍ"+sepa, "i"+"ḍ"+sepa)
    iṇ_sepa = iḍ_sepa.replace("i"+sepa+"ṇ"+sepa, "i"+"ṅ"+sepa)
    it_sepa = iṇ_sepa.replace("i"+sepa+"t"+sepa, "i"+"t"+sepa)
    id_sepa = it_sepa.replace("i"+sepa+"d"+sepa, "i"+"d"+sepa)
    in_sepa = id_sepa.replace("i"+sepa+"n"+sepa, "i"+"n"+sepa)
    ip_sepa = in_sepa.replace("i"+sepa+"p"+sepa, "i"+"p"+sepa)
    ib_sepa = ip_sepa.replace("i"+sepa+"b"+sepa, "i"+"b"+sepa)
    im_sepa = ib_sepa.replace("i"+sepa+"m"+sepa, "i"+"m"+sepa)

    uk_sepa = im_sepa.replace("u"+sepa+"k"+sepa, "u"+"k"+sepa)
    ug_sepa = uk_sepa.replace("u"+sepa+"g"+sepa, "u"+"g"+sepa)
    uṅ_sepa = ug_sepa.replace("u"+sepa+"ṅ"+sepa, "u"+"ṅ"+sepa)
    uc_sepa = uṅ_sepa.replace("u"+sepa+"c"+sepa, "u"+"c"+sepa)
    uj_sepa = uc_sepa.replace("u"+sepa+"j"+sepa, "u"+"j"+sepa)
    uñ_sepa = uj_sepa.replace("u"+sepa+"ñ"+sepa, "u"+"ñ"+sepa)
    uṭ_sepa = uñ_sepa.replace("u"+sepa+"ṭ"+sepa, "u"+"ṭ"+sepa)
    uḍ_sepa = uṭ_sepa.replace("u"+sepa+"ḍ"+sepa, "u"+"ḍ"+sepa)
    uṇ_sepa = uḍ_sepa.replace("u"+sepa+"ṇ"+sepa, "u"+"ṅ"+sepa)
    ut_sepa = uṇ_sepa.replace("u"+sepa+"t"+sepa, "u"+"t"+sepa)
    ud_sepa = ut_sepa.replace("u"+sepa+"d"+sepa, "u"+"d"+sepa)
    un_sepa = ud_sepa.replace("u"+sepa+"n"+sepa, "u"+"n"+sepa)
    up_sepa = un_sepa.replace("u"+sepa+"p"+sepa, "u"+"p"+sepa)
    ub_sepa = up_sepa.replace("u"+sepa+"b"+sepa, "u"+"b"+sepa)
    um_sepa = ub_sepa.replace("u"+sepa+"m"+sepa, "u"+"m"+sepa)

    āk_sepa = um_sepa .replace("ā"+sepa+"k"+sepa, "ā"+"k"+sepa)
    ...
    #UPPERCASE
    AK_sepa = om_sepa.replace("A"+sepa+"K"+sepa, "A"+"K"+sepa)
    AG_sepa = AK_sepa.replace("A"+sepa+"G"+sepa, "A"+"G"+sepa)
    AṄ_sepa = AG_sepa.replace("A"+sepa+"Ṅ"+sepa, "A"+"Ṅ"+sepa)
    AC_sepa = AṄ_sepa.replace("A"+sepa+"C"+sepa, "A"+"C"+sepa)
    AJ_sepa = AC_sepa.replace("A"+sepa+"J"+sepa, "A"+"J"+sepa)
